 ...
 */
export class Text extends AbstractField<FieldArgs, string> implements EditorField<string>{
  ...
  field ({ value, onChange }: EditorFieldProps<string>) {
    ...
    return <div class="form-group">
      ...
      {this.args.multiline ?
        <textarea id={id} class="form-control" defaultValue={value}
                  onInput={e => onChange((e.target as HTMLTextAreaElement).value)}/> :
        <input type="text" id={id} class="form-control" defaultValue={value}
